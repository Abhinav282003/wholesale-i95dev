...
export const action = async ({ request }) => {
  ...
  if (topic === "COMPANIES_UPDATE") {
    try {
      ...
      console.log(`Recorded company update for ID: ${companyId}`);
    } catch (error) {
      console.error("Error recording company update:", error);
    }
  }
